...
@Component({
  selector: 'app-two-category',
  templateUrl: './two-category.component.html',
  styleUrls: ['./two-category.component.scss']
})
export class TwoCategoryComponent implements OnInit {
